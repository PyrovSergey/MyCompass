...
class CustomSwitch: UIControl {
    ...
    @IBInspectable  public var onTintColor: UIColor = UIColor.red {
        didSet {
            self.setupUI()
        }
    }
    
    @IBInspectable public var offTintColor: UIColor = UIColor(red: 144/255, green: 202/255, blue: 119/255, alpha: 1) {
        didSet {
            self.setupUI()
        }
    }
...
extension CustomSwitch {
    ...
    fileprivate func setupLabels() {
        ...
        self.labelOff.text = "On"
        self.labelOn.text = "Off"
